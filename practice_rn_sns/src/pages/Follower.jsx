  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#FFF'}}>
      <View
        ...
        <Text style={{fontSize: 16, fontWeight: 'bold'}}>water_is_self</Text>
        <View style={{width: 40}} />
      </View>
      <Tab.Navigator
        screenOptions={{
        ...
        <Tab.Screen name="123 Follower" component={FollowerTab} />
        <Tab.Screen name="123 Following" component={FollowingTab} />
      </Tab.Navigator>
    </SafeAreaView>
  );
};
